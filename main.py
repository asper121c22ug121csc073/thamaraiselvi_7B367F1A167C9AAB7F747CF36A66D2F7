''' Implement a clas called bankaccount that represnts a bank account. the class should have private
attributes for account number, acoount holder name, and account balance. include methods to
...
def deposit(self, amount):
    if amount > 0:
     ...
     print("dposited ₹{}. new balance: ₹{}".formet(amount,       
